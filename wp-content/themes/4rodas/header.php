<head>
  ...
  <nav class="navbar navbar-default">
    ...
    <div class="navbar-header">
      ...
      <div class="search"><span class="glyphicon glyphicon-search visible-xs"></span></div>
      <a class="navbar-brand" href="#"><img src="wp-content/themes/4rodas/imagens/logo-4rodas.gif" width="220" height="77" alt=""/></a>
    </div>
    ...
    <div class="container">
    <nav class="navbar-2 navbar-default-2 visible-md visible-lg">
    
        <div class="navbar-header-2">
          <a class="navbar-brand" href="#"><img src="wp-content/themes/4rodas/imagens/mais-acessados.gif" width="150" height="28" alt=""/></a>
    </div>
     <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav-2">
        <li><a href="#">SALÃO DO AUTOMÓVEL</a></li>
        <li><a href="#">RENEGADE</a></li>
        <li><a href="#">NOVA SANDERO</a></li>
        ...
        <li class="visible-lg"><a href="#">CIVIC</a></li>
        <li class="visible-lg"><a href="#">| A-Z |</a></li>
      </ul>
